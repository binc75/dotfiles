...
alias bk_homedir='cd ~; tar czf /backup/workstation/desktop_homedir_backup_$(date +%Y-%m-%d).tar.gz . --exclude=MS-Office_201
0_Win_EN --exclude=Downloads --exclude="VirtualBox VMs" --exclude=backup --exclude=.gnome --exclude=.compiz --exclude=.purple
